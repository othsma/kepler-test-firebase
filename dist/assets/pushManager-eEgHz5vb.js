import{y as m,z as y,C as T,A as R,E as X,F as Se,B as j,D as Ae,G as Ee,H as _e,I as F,J as Ne,K as S,r as A,d as E,L as Ce,M as Oe}from"./vendor-firebase-_xt56fuP.js";import{n as _}from"./index-BRsv3OUw.js";const Z="@firebase/installations",K="0.6.9";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ge="firebase-installations-database",ze=1,h="firebase-installations-store";let N=null;function q(){return N||(N=j(Ge,ze,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(h)}}})),N}async function k(e,t){const n=I(e),i=(await q()).transaction(h,"readwrite"),r=i.objectStore(h),s=await r.get(n);return await r.put(t,n),await i.done,(!s||s.fid!==t.fid)&&fe(e,t.fid),t}async function le(e){const t=I(e),o=(await q()).transaction(h,"readwrite");await o.objectStore(h).delete(t),await o.done}async function v(e,t){const n=I(e),i=(await q()).transaction(h,"readwrite"),r=i.objectStore(h),s=await r.get(n),c=t(s);return c===void 0?await r.delete(n):await r.put(c,n),await i.done,c&&(!s||s.fid!==c.fid)&&fe(e,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function L(e){let t;const n=await v(e.appConfig,o=>{const i=Je(o),r=Ye(e,i);return t=r.registrationPromise,r.installationEntry});return n.fid===M?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Je(e){const t=e||{fid:Ve(),registrationStatus:0};return ge(t)}function Ye(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const i=Promise.reject(g.create("app-offline"));return{installationEntry:t,registrationPromise:i}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},o=Qe(e,n);return{installationEntry:n,registrationPromise:o}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:Xe(e)}:{installationEntry:t}}async function Qe(e,t){try{const n=await Le(e,t);return k(e.appConfig,n)}catch(n){throw oe(n)&&n.customData.serverCode===409?await le(e.appConfig):await k(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function Xe(e){let t=await H(e.appConfig);for(;t.registrationStatus===1;)await ue(100),t=await H(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:o}=await L(e);return o||n}return t}function H(e){return v(e,t=>{if(!t)throw g.create("installation-not-found");return ge(t)})}function ge(e){return Ze(e)?{fid:e.fid,registrationStatus:0}:e}function Ze(e){return e.registrationStatus===1&&e.registrationTime+ee<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function et({appConfig:e,heartbeatServiceProvider:t},n){const o=tt(e,n),i=Fe(e,n),r=t.getImmediate({optional:!0});if(r){const u=await r.getHeartbeatsHeader();u&&i.append("x-firebase-client",u)}const s={installation:{sdkVersion:te,appId:e.appId}},c={method:"POST",headers:i,body:JSON.stringify(s)},f=await ce(()=>fetch(o,c));if(f.ok){const u=await f.json();return re(u)}else throw await se("Generate Auth Token",f)}function tt(e,{fid:t}){return`${ie(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O="fcm_token_details_db",vt=5,G="fcm_token_object_Store";async function St(e){if("databases"in indexedDB&&!(await indexedDB.databases()).map(r=>r.name).includes(O))return null;let t=null;return(await j(O,vt,{upgrade:async(o,i,r,s)=>{var c;if(i<2||!o.objectStoreNames.contains(G))return;const f=s.objectStore(G),u=await f.index("fcmSenderId").get(e);if(await f.clear(),!!u){if(i===2){const a=u;if(!a.auth||!a.p256dh||!a.endpoint)return;t={token:a.fcmToken,createTime:(c=a.createTime)!==null&&c!==void 0?c:Date.now(),subscriptionOptions:{auth:a.auth,p256dh:a.p256dh,endpoint:a.endpoint,swScope:a.swScope,vapidKey:typeof a.vapidKey=="string"?a.vapidKey:p(a.vapidKey)}}}else if(i===3){const a=u;t={token:a.fcmToken,createTime:a.createTime,subscriptionOptions:{auth:p(a.auth),p256dh:p(a.p256dh),endpoint:a.endpoint,swScope:a.swScope,vapidKey:p(a.vapidKey)}}}else if(i===4){const a=u;t={token:a.fcmToken,createTime:a.createTime,subscriptionOptions:{auth:p(a.auth),p256dh:p(a.p256dh),endpoint:a.endpoint,swScope:a.swScope,vapidKey:p(a.vapidKey)}}}}}})).close(),await S(O),await S("fcm_vapid_details_db"),await S("undefined"),At(t)?t:null}function At(e){if(!e||!e.subscriptionOptions)return!1;const{subscriptionOptions:t}=e;return typeof e.createTime=="number"&&e.createTime>0&&typeof e.token=="string"&&e.token.length>0&&typeof t.auth=="string"&&t.auth.length>0&&typeof t.p256dh=="string"&&t.p256dh.length>0&&typeof t.endpoint=="string"&&t.endpoint.length>0&&typeof t.swScope=="string"&&t.swScope.length>0&&typeof t.vapidKey=="string"&&t.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Et="firebase-messaging-database",_t=1,b="firebase-messaging-store";let P=null;function ye(){return P||(P=j(Et,_t,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(b)}}})),P}async function Nt(e){const t=Te(e),o=await(await ye()).transaction(b).objectStore(b).get(t);if(o)return o;{const i=await St(e.appConfig.senderId);if(i)return await x(e,i),i}}async function x(e,t){const n=Te(e),i=(await ye()).transaction(b,"readwrite");return await i.objectStore(b).put(t,n),await i.done,t}function Te({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mt=7*24*60*60*1e3;async function Rt(e){const t=await Ft(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:p(t.getKey("auth")),p256dh:p(t.getKey("p256dh"))},o=await Nt(e.firebaseDependencies);if(o){if(Kt(o.subscriptionOptions,n))return Date.now()>=o.createTime+Mt?jt(e,{token:o.token,createTime:Date.now(),subscriptionOptions:n}):o.token;try{await Dt(e.firebaseDependencies,o.token)}catch(i){console.warn(i)}return z(e.firebaseDependencies,n)}else return z(e.firebaseDependencies,n)}async function jt(e,t){try{const n=await Pt(e.firebaseDependencies,t),o=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await x(e.firebaseDependencies,o),n}catch(n){throw n}}async function z(e,t){const o={token:await Ot(e,t),createTime:Date.now(),subscriptionOptions:t};return await x(e,o),o.token}async function Ft(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:It(t)})}function Kt(e,t){const n=t.vapidKey===e.vapidKey,o=t.endpoint===e.endpoint,i=t.auth===e.auth,r=t.p256dh===e.p256dh;return n&&o&&i&&r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
